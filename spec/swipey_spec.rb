...
describe Swipey::CreditCard do
  ...
  context "errors" do
    before do
      @visa_card = "%B4788250000028291CARD345601?;478825000002821015432112345601?"
      @swipe = Swipey::CreditCard.new(@card_with_errors)
      puts @swipe.to_yaml
    end
    
    it "accesors should be nil" do
      @swipe.first_name.should be_nil
      @swipe.last_name.should be_nil
      @swipe.card_number.should be_nil
      @swipe.exp_date.should be_nil
      @swipe.track2.should be_nil
    end
  end
...
describe OldSwipey::CreditCard do
  before do
    @visa_card = "%B4788250000028291^CARD/PAYMENTECH TEST^14051015432112345601?;4788250000028291=14051015432112345601?"
    @swipe = OldSwipey::CreditCard.new(@visa_card)
  end
  ...
  context "errors" do
    before do
      @visa_card = "%B4788250000028291CARD345601?;4788250000028291456=14051015432112345601?"
      @swipe = OldSwipey::CreditCard.new(@card_with_errors)
      puts @swipe.to_yaml
    end
